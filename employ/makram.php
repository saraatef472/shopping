        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="proj.php" class="nav-item nav-link">Admin panel</a>
    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-1.jpg);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Makram Ebeid Branch</h1>

                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Egypt</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <h1 class="mb-5">Phone Numbers</h1>
                <h6 class="text-primary text-uppercase"> +2001127931929 </h6>
                <h6 class="text-primary text-uppercase"> +2001032809532 </h6>
                <h6 class="text-primary text-uppercase"> +2001013925179 </h6>
            ...
            <div class="row g-4">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3453.4820881959545!2d31.344359375135515!3d30.05171291822703!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583e7b933f9829%3A0xb0c5f13dd903000f!2s26%20Samir%20Abd%20El-Raouf%2C%20St%2C%20Nasr%20City%2C%20Cairo%20Governorate%204441560%2C%20Egypt!5e0!3m2!1sen!2sus!4v1699625773933!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                </div>
                <div class="col-md-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <h4>LOCATION:</h4>
                        <p class="mb-4">26 Samir Abd El-Raouf, St, Nasr City, Cairo Governorate 4441560, Egypt.</p>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
