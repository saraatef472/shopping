...
#iconm,#iconm2,#iconm3,#iconm4,#iconm5,#iconm6,#iconm7,#iconm8,#iconm9,#iconm10,#iconm11{
display:none;
float: right;
}
#iconp,#iconp1,#iconp2,#iconp3,#iconp4,#iconp5,#iconp6,#iconp7,#iconp8,#iconp9,#iconp10,#iconp11{
    float: right;
}
.pricedetails{
    color:#ffa41c;
...
#myDIV,#myDIV2,#myDIV3,#myDIV4,#myDIV5,#myDIV6,#myDIV7,#myDIV8,#myDIV9,#myDIV10,#myDIV11,#myDIV12,#myDIV13{
    display:none;
...
<div class="container" style="width:100%; padding:7%;color:#000">
         <h5 style="color:#000;font-weight:100">       Selling your samsung a series mobile phone can bring you</h5>
<br>
Our experts will evaluate the device for the correct condition at the time of the handover.
</div>
<div class="alll">
<BR>
<?php if (isset($_GET['device']) && isset($_GET['ram'])&& isset($_GET['storage'])&& isset($_GET['brand']) && isset($_GET['model'])  && isset($_GET['subseries'])  && isset($_GET['processor'])  && isset($_GET['ram'])) {
$ram =  $_GET['ram'];
$device = $_GET['device'];
$brand = $_GET['brand'];
$model = $_GET['model'];
...
$storage = $_GET['storage'];
    // header('location: index.php');
}else if (isset($_GET['device']) && isset($_GET['ram'])&& isset($_GET['storage']) && isset($_GET['brand']) && isset($_GET['model'])  && isset($_GET['processor'])  && isset($_GET['ram'])){
    $storage = $_GET['storage'];
    $ram =  $_GET['ram'];
    $device = $_GET['device'];
    $brand = $_GET['brand'];
   ...
   // $subseries = $_GET['subseries'];
    $processor = $_GET['processor'];
}else if(isset($_GET['device']) && isset($_GET['ram']) && isset($_GET['storage']) && isset($_GET['brand']) && isset($_GET['model'])  && isset($_GET['subseries'])){
    $device = $_GET['device'];
    $ram =  $_GET['ram'];
    $brand = $_GET['brand'];
    $model = $_GET['model'];
    ...
    $processor = $_GET['processor'];
    $storage = $_GET['storage'];
}else if(isset($_GET['device'])  && isset($_GET['ram'])&& isset($_GET['storage']) && isset($_GET['brand']) && isset($_GET['model'])){
    $device = $_GET['device'];
    $ram =  $_GET['ram'];
    $brand = $_GET['brand'];
    $model = $_GET['model'];
...
else if(isset($_GET['device']) && isset($_GET['brand']) && isset($_GET['model'])){
    $device = $_GET['device'];
    //$ram =  $_GET['ram'];
    $brand = $_GET['brand'];
    $model = $_GET['model'];
...
$result = mysqli_query($conn, "SELECT DISTINCT * FROM `trade_in` WHERE device ='$device' AND  brand ='$brand' AND  model ='$model' AND  processor ='$processor' AND  ram ='$ram' AND  storage ='$storage' AND  subseries ='$subseries'");
    if($result->num_rows>0){
...
<button onclick="myFunction11()" class="bu11">Flwaless &nbsp; &nbsp; <span class="price"><?php echo $row['flawless_price']?></span> <span class="pricedetails">&nbsp;  (Special Offer: Get additional AED 50)</span>  <span id="iconp11"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.75 12.5L10 6.25L16.25 12.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></span> <span id="iconm11"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.75 12.5L10 6.25L16.25 12.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></span>
<div id="myDIV11" class="div11">
<ul>
    <li>Screen: No scratches</li>
<li>Body: No dents</li>
<li>Battery > 90%</li>
<li>Device fully functional</li>
</ul>
</div>
<br><br>
<button onclick="myFunction12()" class="bu11">GOOD &nbsp; &nbsp; <span class="price"><?php echo $row['good_price']?></span>  <span class="pricedetails">&nbsp; (Special Offer: Get additional AED 44)</span>   <span id="iconp12"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.75 12.5L10 6.25L16.25 12.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></span>
<div id="myDIV12" class="div11">
<ul>
    <li>Screen: No scratches</li>
<li>Body: No dents</li>
<li>Battery > 90%</li>
<li>Device fully functional</li>
       ...
       // echo $device;
echo"<script> window.location.href='result2.php?brand= $brand&model= $model&processor= $processor&device=$device&storage=$storage&ram=$ram'</script>";
    }?></div>
</div>
<!-- end second section -->
...
function myFunction11() {
  ...
  var y = document.getElementById("iconp11");
  var z = document.getElementById("iconm11");
...
var y = document.getElementById("iconp12");
var z = document.getElementById("iconm12");
