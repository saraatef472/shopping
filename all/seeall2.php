...
if(isset($_GET['name']))
{
    ...
    $sql = "select * from products where brand = '$search' or description = '$search' or type = '$search'or category = '$search'";
...
<body>
  ...
  <div class="nav-item dropdown">
    ...
    if($result->num_rows>0){
        ...
        ?>
    <a href="seeall2.php?name=<?php echo $row['category']?>" class="dropdown-item" name="details"><?php echo $row['category']?></a>                    
                        <?php }} ?>
                        </div>
...
<button class="btn btn-outline-success my-2 my-sm-0" type="submit"  name="submit">Search</button></form>
    ...
    <!-- Navbar End -->
      ...
      <div class="all5">
    <div class="nav-item dropdown" style="width:20%;margin-top:2%;margin-left:1%;font-size:20px">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Filter by Brand</a>
                        <div class="dropdown-menu fade-up m-0">
                        <?php $result5 = mysqli_query($conn, "SELECT DISTINCT brand from products where category like '%$search%'");
    if($result5->num_rows>0){
        while ($row = mysqli_fetch_array($result5)) {
        ?>
    <a href="seeall2.php?name=<?php echo $row['brand']?>" class="dropdown-item" name="details"><?php echo $row['brand']?>
  </a>                    
                        <?php }} ?>
                        </div>
                    </div>
